...
N -160 50 -120 50 {lab=EOC}
N 120 10 190 10 {lab=clk_samp}
N 120 70 190 70 {lab=clk_sar}
N 120 -20 190 -20 {lab=clk_sampB}
N 120 40 190 40 {lab=clk_sarB}
...
C {devices/lab_pin.sym} 180 10 2 0 {name=p1 sig_type=std_logic lab=clk_samp}
C {devices/lab_pin.sym} 180 70 2 0 {name=p2 sig_type=std_logic lab=clk_sar}
...
C {devices/lab_pin.sym} 180 -20 2 0 {name=p5 sig_type=std_logic lab=clk_sampB}
C {devices/lab_pin.sym} 180 40 2 0 {name=p6 sig_type=std_logic lab=clk_sarB}
