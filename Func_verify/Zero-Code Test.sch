...
12 bit ngõ ra.
Tín hiệu EOC (End of Conversion), nếu có.} -760 -430 0 0 0.3 0.3 {}
...
N 400 -40 420 -40 {lab=CLK_sar}
N 400 -70 420 -70 {lab=CLKB_sar}
N 400 -100 420 -100 {lab=CLK_samp}
N 400 -130 420 -130 {lab=CLKB_samp}
...
C {Pulse_Generator.sym} 280 -90 0 0 {name=x7}
C {devices/gnd.sym} 280 10 0 0 {name=l17 lab=GND}
C {devices/lab_pin.sym} 280 -200 0 0 {name=p68 sig_type=std_logic lab=VDD}
...
C {devices/lab_pin.sym} 420 -40 0 1 {name=p71 sig_type=std_logic lab=CLK_sar}
C {devices/lab_pin.sym} 420 -70 0 1 {name=p72 sig_type=std_logic lab=CLKB_sar
value="pulse (1.8 0 1.5ns 10ps 10ps 1ns 2ns)"}
C {devices/lab_pin.sym} 420 -100 0 1 {name=p74 sig_type=std_logic lab=CLK_samp}
C {devices/lab_pin.sym} 420 -130 0 1 {name=p75 sig_type=std_logic lab=CLKB_samp}
