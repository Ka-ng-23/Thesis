...
12 bit ngõ ra.} -660 -470 0 0 0.3 0.3 {}
...
N 380 -240 380 -210 {lab=VDD}
N 150 -70 150 -60 {lab=GND}
N 150 -150 150 -130 {lab=VCLOCK}
N 150 -160 150 -150 {lab=VCLOCK}
N 150 -160 260 -160 {lab=VCLOCK}
N 240 -100 260 -100 {lab=EOC}
N 500 -80 520 -80 {lab=CLK_sar}
N 500 -110 520 -110 {lab=CLKB_sar}
N 500 -140 520 -140 {lab=CLK_samp}
N 500 -170 520 -170 {lab=CLKB_samp}
...
C {devices/vsource.sym} -290 -180 0 0 {name=Vref_n value=0 savecurrent=false}
C {devices/gnd.sym} -290 -140 0 0 {name=l9 lab=GND}
C {devices/lab_pin.sym} -290 -240 0 0 {name=p34 sig_type=std_logic lab=Vref_n}
C {devices/vsource.sym} -290 -30 0 0 {name=Vref_p value=1.8 savecurrent=false}
...
C {Pulse_Generator.sym} 380 -130 0 0 {name=x7}
C {devices/gnd.sym} 380 -30 0 0 {name=l17 lab=GND}
C {devices/lab_pin.sym} 380 -240 0 0 {name=p68 sig_type=std_logic lab=VDD}
C {devices/vsource.sym} 150 -100 0 1 {name=VCLOCK value="pulse (0 1.8 0ns 0.1ns 0.1ns 100ns 200ns)" savecurrent=false
}
C {devices/gnd.sym} 150 -60 0 1 {name=l18 lab=GND
}
C {devices/lab_pin.sym} 150 -150 0 0 {name=p69 sig_type=std_logic lab=VCLOCK
}
C {devices/lab_pin.sym} 240 -100 0 0 {name=p70 sig_type=std_logic lab=EOC}
C {devices/lab_pin.sym} 520 -80 0 1 {name=p71 sig_type=std_logic lab=CLK_sar}
C {devices/lab_pin.sym} 520 -110 0 1 {name=p72 sig_type=std_logic lab=CLKB_sar
value="pulse (1.8 0 1.5ns 10ps 10ps 1ns 2ns)"}
C {devices/lab_pin.sym} 520 -140 0 1 {name=p74 sig_type=std_logic lab=CLK_samp}
C {devices/lab_pin.sym} 520 -170 0 1 {name=p75 sig_type=std_logic lab=CLKB_samp}
...
C {devices/vsource.sym} -630 -190 0 0 {name=Vin_n value=0 savecurrent=false}
C {devices/vsource.sym} -630 -40 0 0 {name=Vin_p value=1 savecurrent=false}
