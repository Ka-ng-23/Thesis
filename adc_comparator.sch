...
N 90 20 680 20 {lab=CLKB}
N 480 340 560 340 {lab=VDD}
N 480 170 480 340 {lab=VDD}
N 680 20 680 340 {lab=CLKB}
N 600 340 680 340 {lab=CLKB}
...
C {devices/lab_pin.sym} 700 380 0 1 {name=p11 sig_type=std_logic lab=Out_Comp}
