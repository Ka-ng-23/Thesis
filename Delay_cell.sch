...
C {sky130_fd_pr/cap_mim_m3_1.sym} -250 70 0 0 {name=C1 model=cap_mim_m3_1 W=10 L=10 MF=6 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 70 80 0 0 {name=C2 model=cap_mim_m3_1 W=10 L=10 MF=6 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 330 80 0 0 {name=C3 model=cap_mim_m3_1 W=10 L=10 MF=6 spiceprefix=X}
